        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-3 text-white" id="staticBackdropLabel">Tambah Hero</h1>
            ...
            <div class="modal-body">
                    <div class="mb-3 mt-2">
                        <label class="text-white mb-2">Nama Hero :</label>
                        <input type="text" name="nama" class="form-control" id="">
                    </div>
                    <div class="mb-3 mt-2">
                        <label class="text-white mb-2">Role Hero</label>
                        <input type="text" name="nama" class="form-control" id="">
                    </div>
                    <div class="mb-3 mt-2">
                        <label class="text-white mb-2">Specially Hero :</label>
                        <input type="text" name="nama" class="form-control" id="">
                    </div>
                </div>
